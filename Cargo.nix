...
rec {
  ...
  rootCrate = rec {
    packageId = "stackable-commons-operator";
    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "bac8ff44653d477deda650fbd5f690af042df6c2";
          sha256 = "0gz11ifcpa64sqyydyjlzdvsqvj0x8d4wmd1mnrx31hwxzyq2sw0";
        };
        libName = "k8s_version";
        authors = [
      ...
      "xml" = rec {
        ...
        version = "1.2.0";
        edition = "2021";
        sha256 = "0zifgd8wzqgdh5m50qzhzwrwb4rf3q7i1nblvar2f97dmigq5x9d";
        authors = [
