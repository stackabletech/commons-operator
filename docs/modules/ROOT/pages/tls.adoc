...
=== No verification
This example will use TLS but not check the authority of server or client:
...
For this to work you need to create a xref:secret-operator::secretclass.adoc[] that - at least - containts the ca certificate.
